  ...
  return (
    <>
      <div className="bg-[#ffffe4] h-auto w-auto lg:hidden">
          ...
          <div className="sm:h-[45vh] md:h-[55vh] sm:flex sm:justify-between sm:items-center">
            ...
            <div className="hidden sm:w-[13%] sm:h-[90%] sm:flex sm:flex-col sm:justify-between sm:items-center">
              <div className="h-[15%] w-[75%] rounded-3xl relative flex justify-center items-center">
                <Link href={"https://www.linkedin.com/in/ankit-dalei-0aab70161/"} target="_blank">
              ...
              <div className="h-[15%] w-[75%] rounded-3xl relative flex justify-center items-center">
                <Link href={"https://github.com/Ankit-Dalei"} target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={45} height={45}>
              ...
              <div className="h-[15%] w-[75%] rounded-3xl relative flex justify-center items-center">
                <Link href={"https://www.instagram.com/ankitdalei?igsh=MXR4ZmZ2MXFpejZxMA=="} target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={45} height={45}>
              ...
              <div className="h-[15%] w-[75%] rounded-3xl relative flex justify-center items-center">
                <Link href={"https://x.com/AnkitDalei"} target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={45} height={45}>
                  <path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm297.1 84L257.3 234.6 379.4 396H283.8L209 298.1 123.3 396H75.8l111-126.9L69.7 116h98l67.7 89.5L313.6 116h47.5zM323.3 367.6L153.4 142.9H125.1L296.9 367.6h26.3z"/></svg>
                </Link>
              </div>
              <div className="h-[15%] w-[75%] rounded-3xl relative flex justify-center items-center">
                <Link href={"ankitdalei123@gmail.com"} target="_blank">
        ...
        <div className="h-auto w-screen p-2 flex flex-col justify-center items-center mt-2">
          ...
          <div className=" flex h-auto w-[100%] flex-col justify-between items-center mt-3">
            <div className="h-[250px] w-[100%] relative sm:h-[350px] md:h-[420px]">
            ...
            <div className="h-[250px] w-[100%] relative mt-2 sm:h-[350px] md:h-[420px]">
      ...
      <div className="lg:h-auto lg:w-auto hidden lg:block md:overflow-hidden">
        ...
        <div className="lg:h-auto lg:w-full lg:p-2 lg:mt-7">
          <div className="lg:w-full lg:flex lg:justify-between">
            <div className="lg:w-[33%] xl:w-[420px] lg:h-[600px] lg:flex lg:flex-col lg:justify-between lg:items-center">
              <div className="lg:rounded-2xl lg:w-full lg:h-[80px] lg:flex lg:justify-between lg:items-top">
                <div className="h-[50px] w-[50px] rounded-3xl relative flex justify-center items-center">
                  <Link href={"https://www.linkedin.com/in/ankit-dalei-0aab70161/"} target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={40} height={40}>
                    <path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/></svg>
              ...
              <div className=" lg:rounded-2xl lg:w-full lg:h-auto">
                <h2 className="text-black text-2xl font-serif flex justify-center items-center">Skills</h2>
                <div className="h-auto w-full mt-1 grid grid-cols-6 gap-4 justify-items-center items-center">
                  {socialLinks.map((item) => (
                    <div
                      key={item.id}
              ...
              <div className="lg:rounded-2xl lg:w-full lg:h-[350px] mt-3">
                <div className="lg:text-black lg:font-serif lg:flex lg:justify-center lg:items-center lg:text-2xl">Vlogs</div>
                <div className="lg:w-full lg:h-[70%] rounded-2xl relative mt-2">
                  <Link href={`vlog`}>
                    <Image
                    src="/proimg.png"
                    alt="profileImage"
                ...
                <div className="lg:w-full lg:flex lg:justify-end lg:items-center lg:text-black lg:text-xl lg:font-serif mt-2">
                  <Link href={`vlog`}>
                    See More
                  </Link>
                </div>
            ...
            <div className="lg:w-[31%] xl:w-[400px] lg:h-[600px] bg-[#a69494] rounded-b-full p-6 text-center overflow-y-auto">
              <h1 className="text-3xl font-bold tracking-widest text-black mb-6 border-b border-black inline-block pb-1">
                ABOUT ME
              </h1>
              <p className="lg:text-[11.5px] md:text-[13px] italic text-justify text-[#3e3e3e] leading-relaxed font-[cursive]">
                I am a passionate and dedicated Full Stack Developer 
                with a strong command of the MERN stack 
                (MongoDB, Express.js, React.js, Node.js) 
                and solid experience in JavaScript and C++. 
                I specialize in building responsive and 
                user-friendly web applications, ensuring 
                high performance and clean code architecture. 
                My work extends beyond typical development—I’ve 
                successfully integrated real-time data from IoT 
                devices such as ESP8266, DHT22, LDR, and heart 
                rate sensors, enhancing the interactivity and 
                functionality of my projects.<br/>
                I have hands-on experience in both front-end 
                and back-end development and enjoy tackling 
                complex challenges to deliver scalable solutions. 
                Currently, I am diving deeper into industrial 
                automation, sensor data analytics, and 
                machine learning applications to expand my 
                technical horizons. I am a quick learner, 
                a creative problem-solver, and thrive in 
                collaborative, fast-paced environments. 
                My goal is to contribute to innovative 
                tech-driven projects that make a real-world impact.
              </p>
            </div>
            <div className="lg:w-[33%] xl:w-[420px] lg:h-[600px] lg:flex lg:flex-col lg:justify-between lg:items-center">
              <div className="lg:w-full lg:h-[95%] relative">
                <Link href={`https://weather-ten-sigma-87.vercel.app/`} target="_blank">
                  <Image
                  src="/designimg.png"
                  alt="profileImage"
          ...
          <div className="lg:h-auto lg:w-full lg:flex lg:flex-col lg:mt-15">
            <div className="lg:w-full lg:flex lg:justify-between lg:items-center">
              <div className="lg:w-[350px] lg:h-[200px] rounded-2xl relative">
                <Link href={`https://med-guide-gilt.vercel.app/`} target="_blank">
                  <Image
                  src="/proimg2.png"
                  alt="profileImage"
              ...
              <div className="lg:w-[350px] lg:h-[200px] rounded-2xl relative">
                <Link href={`https://tic-tac-toe-nine-cyan.vercel.app/`} target="_blank">
                  <Image
                  src="/proimg3.png"
                  alt="profileImage"
                  fill
              ...
              <div className="lg:w-[350px] lg:h-[200px] rounded-2xl relative">
                <Link href={`https://to-do-dun-psi.vercel.app/`} target="_blank">
                  <Image
                  src="/proimg4.png"
                  alt="profileImage"
                  fill
