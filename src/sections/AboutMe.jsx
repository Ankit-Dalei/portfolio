    ...
    <div className="px-4 py-10 md:px-16 md:py-[48px] lg:px-20 lg:py-[60px]">
      <div className="px-8 flex flex-col md:flex-row justify-between items-start gap-x-16">
        ...
        <div className="mt-8 md:mt-0">
          ...
          <p className="text-zinc-500 font-display py-4">
            I began my journey as a web developer in 2021, and since then, I&apos;ve continued to grow and evolve as a developer, taking on new challenges and learning the latest technologies along the way. Now, in my early thirties, 4 years after starting my web development journey, I&apos;m building cutting-edge web applications using modern technologies such as React.js, JavaScript, Tailwindcss and much more.
          </p>
          <p className="text-zinc-500 font-display py-4">
